        ...
        <div class="col-lg-8 vstack gap-4">
            ...
            <div class="card">
                ...
                <div class="card-header d-sm-flex align-items-center justify-content-between border-0 pb-0">
                    ...
                    <!-- Button modal -->
                    <a class="btn btn-sm btn-primary-soft" href="#" data-bs-toggle="modal" data-bs-target="#modalCreateAlbum"> <i class="fa-solid fa-plus pe-1"></i> Add Photo</a>
                </div>
                <!-- Card header END -->
                <!-- Card body START -->
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        @foreach($albumWithphotos->photos as $photo)
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <!-- Photo -->
                                <a href="{{$photo->pathPhoto}}" data-gallery="image-popup" data-glightbox="description: .custom-desc2; descPosition: left;">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 position-relative">
                            ...
                            <ul class="nav nav-stack py-2 small">
                                <li class="nav-item">
                                    <a class="nav-link" href="#!"> <i class="bi bi-heart-fill text-danger pe-1"></i>32k </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            <ul class="nav nav-stack py-2 small">
                                <li class="nav-item">
                                    <a class="nav-link" href="#!"> <i class="bi bi-heart-fill text-danger pe-1"></i>21k </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            <ul class="nav nav-stack py-2 small">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#!"> <i class="bi bi-chat-left-text-fill pe-1"></i>16k </a>
                                </li>
                            </ul>
                            <!-- glightbox Albums left bar START -->
                            <div class="glightbox-desc custom-desc2">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            <ul class="nav nav-stack py-2 small">
                                <li class="nav-item">
                                    <a class="nav-link" href="#!"> <i class="bi bi-heart-fill text-danger pe-1"></i>20k </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#!"> <i class="bi bi-chat-left-text-fill pe-1"></i>8k </a>
                                </li>
                            </ul>
                            <!-- glightbox Albums left bar START -->
                            <div class="glightbox-desc custom-desc2">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabelCreateAlbum">Add Photo</h5>
